...
const ExamRegistrationForm = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
        ...
        <input type="text" name="admissionNumber" placeholder="Admission Number" value={formData.admissionNumber} onChange={handleChange} />
        <input type="text" name="examRegisterNumber" placeholder="Exam Register Number" value={formData.examRegisterNumber} onChange={handleChange} />
